...
<div class="container px-6 py-8 mx-auto">
    ...
    <div class="mt-8">
        ...
        <div class="p-6 bg-white rounded-md shadow">
            <form action="<?php echo e(route('admin.content.news.update', $news->id)); ?>" method="POST" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="text" name="title" id="title" value="<?php echo e(old('title', $news->title)); ?>" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring focus:ring-blue-200" required>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <input type="text" name="author" id="author" value="<?php echo e(old('author', $news->author)); ?>" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring focus:ring-blue-200">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <select name="status" id="status" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring focus:ring-blue-200" required>
                            ...
                            <option value="archived" <?php echo e(old('status', $news->status) == 'archived' ? 'selected' : ''); ?>>Archived</option>
                        </select>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <input type="datetime-local" name="published_at" id="published_at" value="<?php echo e(old('published_at', $news->published_at ? $news->published_at->format('Y-m-d\TH:i') : '')); ?>" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring focus:ring-blue-200">
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="mt-6">
                    ...
                    <textarea name="short_description" id="short_description" rows="3" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring focus:ring-blue-200"><?php echo e(old('short_description', $news->short_description)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="mt-6">
                    ...
                    <textarea name="content" id="content" rows="8" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring focus:ring-blue-200 ckeditor"><?php echo e(old('content', $news->content)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div id="imagePreview" class="mt-2 <?php echo e($news->image ? '' : 'hidden'); ?>">
                        <img id="preview" src="<?php echo e($news->image ? $news->image_url : '#'); ?>" alt="Preview" class="h-32 object-cover rounded">
                        <?php if($news->image): ?>
                            <p class="text-sm text-gray-500 mt-1">Current image: <?php echo e($news->image); ?></p>
                        <?php endif; ?>
                    </div>
                </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\klinik\resources\views/admin/news/edit.blade.php ENDPATH**/ ?>