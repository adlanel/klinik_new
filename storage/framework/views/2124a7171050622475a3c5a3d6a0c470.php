...
<div class="container px-6 py-8 mx-auto">
    <div class="flex justify-between items-center">
        <h3 class="text-3xl font-medium text-gray-700">Tambah Fasilitas</h3>
    ...
    <div class="mt-8">
        ...
        <div class="bg-white p-6 rounded-md shadow">
            <form action="<?php echo e(route('admin.content.fasilitas.store')); ?>" method="POST" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\klinik\resources\views/admin/fasilitas/create.blade.php ENDPATH**/ ?>