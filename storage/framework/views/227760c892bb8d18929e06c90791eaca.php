...
<?php $__env->startSection('title', $newsItem->title . ' - Al-Fatih Center'); ?>
    ...
    <div class="relative pt-16 pb-10 md:pt-24 md:pb-16 bg-gradient-to-b from-blue-900 to-blue-800">
        <div class="container mx-auto px-6 max-w-5xl relative z-10">
            <div class="text-center text-white py-12 max-w-3xl mx-auto">
                ...
                <h1 class="text-3xl md:text-5xl font-bold mb-6"><?php echo e($newsItem->title); ?></h1>
                ...
                <div class="bg-white rounded-xl shadow-lg overflow-hidden mb-8">
                    ...
                    <div class="w-full h-80 md:h-96 relative">
                        <img 
                            ...
                            onerror="this.src='https://via.placeholder.com/800x500/e2f1ff/2563eb?text=<?php echo e(urlencode($newsItem->title)); ?>'"
                        >
                    </div>
                ...
                <div class="bg-blue-50 rounded-xl p-6 border border-blue-100 mb-10">
                    <div class="flex items-center">
                        <div class="w-16 h-16 rounded-full bg-gradient-to-r from-blue-600 to-blue-400 text-white flex items-center justify-center text-xl font-bold">
                            <?php echo e(substr($newsItem->author, 0, 1)); ?>

                        </div>
                        <div class="ml-5">
                            <h3 class="text-lg font-bold text-gray-800"><?php echo e($newsItem->author); ?></h3>
                ...
                <div class="bg-white rounded-xl shadow-lg overflow-hidden mb-8">
                    <div class="p-6">
                        ...
                        <div class="space-y-6">
                            ...
                            <div class="flex space-x-4">
                                <div class="flex-shrink-0 w-20 h-20 rounded-lg overflow-hidden">
                                    <img 
                                        src="<?php echo e(asset('storage/homepage/news/' . $related->image)); ?>" 
                                ...
                                <div>
                                    <h4 class="font-bold text-gray-700 hover:text-blue-600 transition-colors line-clamp-2">
                                        <a href="<?php echo e(route('news.show', $related->slug)); ?>"><?php echo e($related->title); ?></a>
                                    </h4>
                                    <p class="text-sm text-gray-500 mt-1"><?php echo e($related->formatted_date); ?></p>
                                </div>
                            </div>
                        ...
                        <div class="mt-8 text-center">
                            <a href="<?php echo e(route('news.index')); ?>" class="inline-flex items-center text-blue-600 font-medium hover:text-blue-800 transition-colors">
                                Lihat Semua Artikel
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp2\htdocs\klinik\resources\views/pages/news-detail.blade.php ENDPATH**/ ?>