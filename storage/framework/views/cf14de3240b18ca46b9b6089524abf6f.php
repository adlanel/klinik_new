    ...
    <div class="content-section">
        ...
        <div class="info-grid">
            ...
            <div class="info-row">
                ...
                <div class="info-value"><?php echo e($patient->id_pasien); ?></div>
            </div>
            <div class="info-row">
            ...
            <div class="info-row">
                ...
                <div class="info-value"><?php echo e($patient->cabang->nama_cabang ?? '-'); ?></div>
            </div>
        </div>
    </div>
        ...
        <div class="info-grid">
            ...
            <div class="info-row">
                ...
                <div class="info-value">
                    ...
                    <?php else: ?>
                        <span class="status-badge status-pending"><?php echo e($historyDetail->status ?? 'Belum Dikerjakan'); ?></span>
                    <?php endif; ?>
                </div>
            </div>
        </div>
...
</html><?php /**PATH C:\xampp\htdocs\klinik\resources\views/pages/terapis/patients/history-pdf.blade.php ENDPATH**/ ?>