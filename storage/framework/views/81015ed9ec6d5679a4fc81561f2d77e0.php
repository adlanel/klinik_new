...
<body class="bg-gray-50 overflow-x-hidden">
            ...
            <div class="slider-container relative w-full">
                ...
                <div class="slider-dots absolute bottom-4 left-1/2 transform -translate-x-1/2 hidden md:flex space-x-3 z-10 py-1 px-3 rounded-full bg-black bg-opacity-10 backdrop-blur-sm">
                    <?php $__currentLoopData = $sliders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $slider): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <button class="slider-dot w-2 h-2 rounded-full bg-white bg-opacity-30 hover:bg-opacity-60 transition-all <?php echo e($index === 0 ? 'active bg-opacity-50' : ''); ?>"
            ...
            <div class="flex flex-col md:flex-row items-center gap-10 md:gap-16">
                ...
                <div class="w-full md:w-1/2">
                    <div class="relative rounded-xl overflow-hidden shadow-2xl transform transition-transform hover:scale-[1.02] duration-300 border-2 border-white/30">
                        ...
                        <img 
                            src="<?php echo e($aboutSection->image_url); ?>" 
                ...
                <div class="w-full md:w-1/2">
                    <div class="p-6 md:p-8 bg-white/60 backdrop-blur-sm rounded-2xl shadow-lg border border-white/50">
                        ...
                        <p class="text-lg md:text-xl text-gray-700 leading-relaxed mb-8 mt-8 relative">
                            ...
                            <?php echo e($aboutSection->description); ?>
                        ...
                        <div class="mt-10 relative">
                            ...
                            <a href="<?php echo e(route('about.index')); ?>" class="inline-flex items-center px-8 py-4 bg-gradient-to-r from-blue-600 to-blue-700 text-lg text-white font-medium rounded-lg transition-all duration-300 hover:shadow-lg hover:shadow-blue-500/30 hover:-translate-y-1 group">
        ...
        <div class="container mx-auto px-6 md:px-12 max-w-6xl relative z-10">
            ...
            <div class="flex justify-center">
                ...
                <div class="group bg-white rounded-2xl shadow-lg overflow-hidden transition-all duration-300 hover:shadow-2xl hover:-translate-y-2 relative border border-blue-100/50">
                    ...
                    <div class="h-48 overflow-hidden relative">
                        ...
                        <img 
                            src="<?php echo e($service->image_url); ?>" 
                    ...
                    <div class="p-6 relative">
                        ...
                        <h3 class="font-bold text-xl mb-3 text-blue-800 group-hover:text-blue-600 transition-colors"><?php echo e($service->title); ?></h3>
                        <p class="text-gray-600 mb-5 line-clamp-3"><?php echo e($service->short_description); ?></p>
                        
                        <a 
                            href="<?php echo e(route('service.show', $service->slug)); ?>" 
            ...
            <div class="text-center mt-16">
                <div class="relative inline-block">
                    ...
                    <a href="<?php echo e(route('layanan-fasilitas.index')); ?>" class="relative inline-flex items-center px-8 py-4 bg-white border-2 border-blue-600 text-blue-600 font-semibold rounded-lg hover:bg-blue-600 hover:text-white transition-all duration-300 hover:shadow-lg hover:shadow-blue-500/30">
        ...
        <div class="container mx-auto px-6 md:px-12 max-w-6xl relative z-10">
            ...
            <div class="relative max-w-5xl mx-auto mb-12 overflow-hidden rounded-xl shadow-xl">
                    ...
                    <div class="news-slide w-full min-w-full flex-shrink-0 bg-white overflow-hidden">
                        <div class="flex flex-col md:flex-row h-full">
                            ...
                            <div class="w-full md:w-1/2 h-48 md:h-auto relative overflow-hidden">
                                <img 
                                    src="<?php echo e($newsItem->image_url); ?>" 
                            ...
                            <div class="w-full md:w-1/2 p-6 md:p-8 flex flex-col justify-center">
                                ...
                                <h3 class="text-xl md:text-2xl font-bold mb-4 text-gray-800"><?php echo e($newsItem->title); ?></h3>
                                
                                <p class="text-gray-600 mb-6 line-clamp-3"><?php echo e($newsItem->short_description); ?></p>
                ...
                <div class="absolute bottom-4 left-1/2 transform -translate-x-1/2 flex space-x-2 z-10">
                    <?php $__currentLoopData = $news; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $newsItem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <button class="news-dot w-2 h-2 rounded-full bg-white bg-opacity-50 hover:bg-opacity-100 transition-all <?php echo e($index === 0 ? 'active bg-opacity-100' : ''); ?>" data-index="<?php echo e($index); ?>"></button>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
            </div>
            ...
            <div class="flex justify-center mt-8">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl">
                    <?php $__currentLoopData = $news->take(2); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $newsItem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <!-- CTA Button -->
            <div class="text-center mt-16">
                <a href="<?php echo e(route('news.index')); ?>" class="inline-flex items-center px-8 py-4 bg-gradient-to-r from-blue-700 to-blue-600 text-white font-semibold rounded-lg hover:from-blue-800 hover:to-blue-700 transition-all duration-300 shadow-md hover:shadow-lg hover:shadow-blue-500/30">
    ...
    <section class="py-20 relative overflow-hidden">
        ...
        <div class="absolute inset-0 z-0">
            <!-- Background Image -->
            <div class="absolute inset-0 bg-cover bg-center bg-fixed" style="background-image: url('<?php echo e(asset('storage/homepage/testimonials/background.jpg')); ?>');">
        ...
        <div class="container mx-auto px-6 md:px-12 max-w-6xl relative z-10">
            ...
            <div class="relative max-w-5xl mx-auto mb-12">
                    ...
                    <div class="flex transition-transform duration-500">
                        ...
                        <div class="testimonial-slide w-full min-w-full flex-shrink-0 p-4 md:p-6">
                            <div class="relative">
                                ...
                                <div class="absolute inset-0 bg-cover bg-center opacity-5" style="background-image: url('<?php echo e($testimonial->image_url); ?>'); filter: blur(10px);"></div>
                                    ...
                                    <div class="w-full md:w-3/4 p-6 md:p-10">
                                        <div class="bg-white bg-opacity-95 backdrop-filter backdrop-blur-sm p-6 md:p-8 rounded-xl shadow-lg border border-blue-100">
                                            ...
                                            <div class="flex items-center">
                                                <img 
                                                    src="<?php echo e($testimonial->image_url); ?>" 
                                                ...
                                                <div>
                                                    ...
                                                    <p class="text-sm text-blue-700"><?php echo e($testimonial->role); ?></p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                ...
                <div class="absolute -bottom-10 left-1/2 transform -translate-x-1/2 flex space-x-3 z-10">
                    <?php $__currentLoopData = $testimonials; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $testimonial): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <button class="testimonial-dot w-3 h-3 rounded-full bg-white bg-opacity-70 hover:bg-opacity-100 transition-all duration-300 <?php echo e($index === 0 ? 'active bg-opacity-100 w-6' : ''); ?>" data-index="<?php echo e($index); ?>"></button>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
            </div>
        </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            <?php if(isset($scrollToConsultation) && $scrollToConsultation): ?>
            document.addEventListener('DOMContentLoaded', function() {
            ...
            <div id="appointment-form" class="max-w-4xl mx-auto bg-white rounded-xl shadow-xl overflow-hidden">
                <div class="md:flex">
                    ...
                    <div class="w-full md:w-2/3 p-8">
                        ...
                        <form action="<?php echo e(route('consultation.store')); ?>" method="POST" class="space-y-6" id="consultation-form-element">
                            <?php echo csrf_field(); ?>
                                ...
                                <div class="space-y-4">
                                    <div>
                                        ...
                                        <input 
                                            ...
                                            id="nama_orang_tua" 
                                            name="nama_orang_tua" 
                                            class="w-full px-4 py-3 rounded-lg focus:ring-2 focus:ring-blue-500 focus:outline-none <?php echo e($errors->has('nama_orang_tua') ? 'border border-red-500' : 'border border-gray-300'); ?>" 
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div>
                                        ...
                                        <input 
                                            ...
                                            id="email" 
                                            name="email" 
                                            class="w-full px-4 py-3 rounded-lg focus:ring-2 focus:ring-blue-500 focus:outline-none <?php echo e($errors->has('email') ? 'border border-red-500' : 'border border-gray-300'); ?>" 
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div>
                                        ...
                                        <input 
                                            ...
                                            id="phone" 
                                            name="phone" 
                                            class="w-full px-4 py-3 rounded-lg focus:ring-2 focus:ring-blue-500 focus:outline-none <?php echo e($errors->has('phone') ? 'border border-red-500' : 'border border-gray-300'); ?>" 
                                ...
                                <div class="space-y-4">
                                    <div>
                                        ...
                                        <input 
                                            ...
                                            id="patient_name" 
                                            name="patient_name" 
                                            class="w-full px-4 py-3 rounded-lg focus:ring-2 focus:ring-blue-500 focus:outline-none <?php echo e($errors->has('patient_name') ? 'border border-red-500' : 'border border-gray-300'); ?>" 
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        <div>
                                            ...
                                            <input 
                                                ...
                                                id="tempat_lahir" 
                                                name="tempat_lahir" 
                                                class="w-full px-4 py-3 rounded-lg focus:ring-2 focus:ring-blue-500 focus:outline-none <?php echo e($errors->has('tempat_lahir') ? 'border border-red-500' : 'border border-gray-300'); ?>" 
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div>
                                            ...
                                            <input 
                                                ...
                                                id="tanggal_lahir" 
                                                name="tanggal_lahir" 
                                                class="w-full px-4 py-3 rounded-lg focus:ring-2 focus:ring-blue-500 focus:outline-none <?php echo e($errors->has('tanggal_lahir') ? 'border border-red-500' : 'border border-gray-300'); ?>" 
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div>
                                        ...
                                        <textarea 
                                            ...
                                            name="alamat" 
                                            rows="2" 
                                            class="w-full px-4 py-3 rounded-lg focus:ring-2 focus:ring-blue-500 focus:outline-none <?php echo e($errors->has('alamat') ? 'border border-red-500' : 'border border-gray-300'); ?>" 
                                ...
                                <div class="space-y-4">
                                    <div>
                                        ...
                                        <input 
                                            ...
                                            id="meeting_date" 
                                            name="meeting_date" 
                                            class="w-full px-4 py-3 rounded-lg focus:ring-2 focus:ring-blue-500 focus:outline-none <?php echo e($errors->has('meeting_date') ? 'border border-red-500' : 'border border-gray-300'); ?>"
                                            min="<?php echo e(date('Y-m-d')); ?>"
                                            value="<?php echo e(old('meeting_date')); ?>"
                                            required
                                        >
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div>
                                        ...
                                        <textarea 
                                            ...
                                            name="complaint" 
                                            rows="4" 
                                            class="w-full px-4 py-3 rounded-lg focus:ring-2 focus:ring-blue-500 focus:outline-none <?php echo e($errors->has('complaint') ? 'border border-red-500' : 'border border-gray-300'); ?>" 
                                            placeholder="Ceritakan keluhan anak atau jenis terapi yang diinginkan"
                                            required
                                        ><?php echo e(old('complaint')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="relative">
                                    <select
                                        id="cabang_id"
                                        name="cabang_id"
                                        class="appearance-none w-full px-4 py-3 rounded-lg focus:ring-2 focus:ring-blue-500 focus:outline-none <?php echo e($errors->has('cabang_id') ? 'border border-red-500' : 'border border-gray-300'); ?> bg-white"
                                        required
                                    >
                                        <option value="" disabled <?php echo e(old('cabang_id') ? '' : 'selected'); ?>>Pilih cabang klinik</option>
                                        <?php $__currentLoopData = $branches; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $branch): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($branch->id); ?>" <?php echo e(old('cabang_id') == $branch->id ? 'selected' : ''); ?> 
                                            title="<?php echo e($branch->nama_cabang); ?> - <?php echo e($branch->alamat); ?>" data-full-info="<?php echo e($branch->nama_cabang); ?> - <?php echo e($branch->alamat); ?>">
                                            <?php echo e($branch->nama_cabang); ?><?php echo e(strlen($branch->alamat) > 15 ? ' - ' . substr($branch->alamat, 0, 15) . '...' : ' - ' . $branch->alamat); ?>
...
<?php /**PATH C:\xampp2\htdocs\klinik\resources\views/beranda.blade.php ENDPATH**/ ?>