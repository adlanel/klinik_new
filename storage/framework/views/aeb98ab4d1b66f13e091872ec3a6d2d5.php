<div id="sidebar" class="fixed inset-y-0 left-0 w-64 bg-gray-800 text-white sidebar transform -translate-x-full md:translate-x-0 transition-transform duration-300 ease-in-out z-30 md:relative">
    <div class="px-4 py-6">
        ...
        <nav class="mt-6">
            <div class="space-y-2">
                <!-- Jadwal Tugas -->
                <a href="<?php echo e(route('terapis.jadwal-tugas.index')); ?>" class="flex items-center px-4 py-3 hover:bg-gray-700 rounded-md <?php echo e(Request::routeIs('terapis.jadwal-tugas.*') ? 'bg-blue-600' : ''); ?>">
...
</script><?php /**PATH C:\xampp\htdocs\klinik\resources\views/layouts/terapis/sidebar.blade.php ENDPATH**/ ?>