...
<div class="container px-6 py-8 mx-auto">
    ...
    <div class="mt-8">
        ...
        <div class="bg-white p-6 rounded-md shadow">
            <form action="<?php echo e(route('admin.content.layanan.update', $layanan->id)); ?>" method="POST" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                <?php echo method_field('PUT'); ?>
                
                <div class="mb-6">
                    <label for="title" class="block text-sm font-medium text-gray-700 mb-2">Judul Layanan</label>
                    <input type="text" name="title" id="title" value="<?php echo e(old('title', $layanan->title)); ?>" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring focus:ring-blue-200" required>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="mb-6">
                    ...
                    <textarea name="short_description" id="short_description" rows="3" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring focus:ring-blue-200"><?php echo e(old('short_description', $layanan->short_description)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="mb-6">
                    ...
                    <textarea name="description" id="description" rows="10" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring focus:ring-blue-200"><?php echo e(old('description', $layanan->description)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="mb-6">
                    ...
                    <div class="mb-4">
                        <img src="<?php echo e($layanan->image_url); ?>" alt="Current Image" class="h-40 object-contain border rounded">
                    </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\klinik\resources\views/admin/layanan/edit.blade.php ENDPATH**/ ?>