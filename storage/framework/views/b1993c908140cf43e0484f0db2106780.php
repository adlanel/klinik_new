...
<?php $__env->startSection('title', 'Tambah Banner Baru'); ?>
...
<div class="bg-white rounded-lg shadow-md p-6">
    ...
    <form action="<?php echo e(route('admin.content.banners.store')); ?>" method="POST" enctype="multipart/form-data" class="max-w-4xl">
        <?php echo csrf_field(); ?>
        ...
        <div class="mb-6">
            ...
            <input type="number" name="order_number" id="order_number" value="<?php echo e($nextOrderNumber); ?>" min="1" class="mt-1 block w-full md:w-1/4 rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-500 focus:ring-opacity-50" required>
...
<?php echo $__env->make('layouts.admin.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp2\htdocs\klinik\resources\views/admin/banners/create.blade.php ENDPATH**/ ?>