                ...
                <?php $__empty_1 = true; $__currentLoopData = $patients ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $patient): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr>
                        ...
                        <td class="px-4 py-4 whitespace-nowrap text-center">
                            <div class="text-sm text-gray-900"><?php echo e($index + 1); ?></div>
                        </td>
                        ...
                        <td class="px-4 py-4 whitespace-nowrap text-center">
                            <div class="text-sm text-gray-900">
                                <?php if($patient->tanggal_lahir): ?>
                                    <?php echo e(\Carbon\Carbon::parse($patient->tanggal_lahir)->age); ?> th
                                <?php else: ?>
                                    -
                                <?php endif; ?>
                            </div>
                        ...
                        <td class="px-4 py-4 whitespace-nowrap text-center">
                            <div class="text-sm text-gray-900">
                                <?php echo e($patient->jenis_kelamin == 'Laki-laki' ? 'L' : 'P'); ?>
                        ...
                        <!-- Detail Profil -->
                        <td class="px-4 py-4 whitespace-nowrap text-center">
                            <a href="<?php echo e(route('terapis.patients.show', $patient->id_pasien)); ?>" class="text-blue-600 hover:text-blue-900 p-2 rounded-full hover:bg-blue-50">
                        ...
                        <!-- History -->
                        <td class="px-4 py-4 whitespace-nowrap text-center">
                            <a href="<?php echo e(route('terapis.patients.history', $patient->id_pasien)); ?>" class="text-purple-600 hover:text-purple-900 p-2 rounded-full hover:bg-purple-50">
...
<?php echo $__env->make('layouts.terapis.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\klinik\resources\views/pages/terapis/patients/index.blade.php ENDPATH**/ ?>