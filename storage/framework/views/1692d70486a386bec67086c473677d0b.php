...
<section class="py-20">
    <div class="container mx-auto px-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
            <?php $__currentLoopData = $layananList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $layanan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="bg-white rounded-xl shadow-md overflow-hidden hover:shadow-lg transition-shadow duration-300">
                <div class="relative h-56 overflow-hidden">
                    <img 
                        src="<?php echo e(asset('storage/homepage/layanan/' . $layanan->image)); ?>" 
                        alt="<?php echo e($layanan->title); ?>" 
                        class="w-full h-full object-cover transition-transform duration-500 hover:scale-105"
                        onerror="this.src='https://via.placeholder.com/600x400/e2f1ff/2563eb?text=<?php echo e(urlencode($layanan->title)); ?>'"
                    >
                    <div class="absolute inset-0 bg-gradient-to-t from-black/70 via-transparent to-transparent"></div>
                    <h3 class="absolute bottom-4 left-4 text-xl font-bold text-white"><?php echo e($layanan->title); ?></h3>
                </div>
                <div class="p-6">
                    <p class="text-gray-700 mb-4"><?php echo e($layanan->short_description); ?></p>
                    <a href="<?php echo e(route('service.show', $layanan->slug)); ?>" class="inline-flex items-center text-blue-600 font-semibold group">
    ...
    <div class="container mx-auto px-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div class="bg-white rounded-xl shadow-md overflow-hidden hover:shadow-lg transition-shadow duration-300">
                <div class="relative h-56 overflow-hidden">
                    <img 
                        src="<?php echo e(asset('storage/homepage/fasilitas/' . $fasilitas->image)); ?>" 
                        alt="<?php echo e($fasilitas->title); ?>" 
                        class="w-full h-full object-cover transition-transform duration-500 hover:scale-105"
                        onerror="this.src='https://via.placeholder.com/600x400/e6f7ff/0284c7?text=<?php echo e(urlencode($fasilitas->title)); ?>'"
                    >
                </div>
                <div class="p-6">
                    <h3 class="text-xl font-bold text-gray-800 mb-2"><?php echo e($fasilitas->title); ?></h3>
                    <p class="text-gray-700"><?php echo e($fasilitas->short_description); ?></p>
                    <div class="mt-4 pt-4 border-t border-gray-100">
                        <p class="text-gray-600 text-sm italic"><?php echo e($fasilitas->description); ?></p>
                    </div>
                </div>
            </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp2\htdocs\klinik\resources\views/pages/layanan-fasilitas.blade.php ENDPATH**/ ?>