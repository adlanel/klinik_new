    ...
    <div class="container mx-auto px-4 py-8">
        <div class="max-w-2xl mx-auto">
            ...
            <div class="bg-white shadow-lg rounded-xl p-8">
                <form id="bcryptForm" class="space-y-6" action="<?php echo e(url('/bcrypt')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                    <div>
                ...
                <!-- Result Section -->
                <div id="resultSection" class="mt-8 <?php echo e(isset($hash) ? '' : 'hidden'); ?>">
                    ...
                    <div class="bg-gray-50 border rounded-lg p-4">
                        ...
                        <textarea id="hashResult" 
                                  ...
                                  placeholder="Hash akan muncul di sini..."><?php echo e($hash ?? ''); ?></textarea>
                    </div>
                    ...
                    <div class="mt-4 bg-green-50 border border-green-200 rounded-lg p-4">
                        ...
                        <div class="space-y-2 text-sm">
                            <div>
                                <strong>Password:</strong> <code><?php echo e($original_password); ?></code>
                            </div>
                            <div>
                                <strong>Cost:</strong> <?php echo e($cost ?? 10); ?>

                            </div>
                            <div>
                                <strong>Hash Length:</strong> <?php echo e(strlen($hash)); ?> characters
                            </div>
                            <div>
                                <strong>Algorithm:</strong> <?php echo e(password_get_info($hash)['algoName'] ?? 'bcrypt'); ?>
...
UPDATE users SET password = '<span id="hashForLaravel"><?php echo e($hash ?? '$2y$10$...'); ?></span>' WHERE email = 'user@example.com';
                                </code>
                            </div>
                            <div>
                                <strong>Laravel Hash::make():</strong>
                                <code class="block bg-white p-2 rounded border text-xs mt-1 font-mono">
Hash::make('<?php echo e($original_password ?? 'your_password'); ?>')
                                </code>
                            </div>
                            <div>
                                <strong>Verify Password:</strong>
                                <code class="block bg-white p-2 rounded border text-xs mt-1 font-mono">
Hash::check('<?php echo e($original_password ?? 'plaintext_password'); ?>', $hashedPassword)
                                </code>
                            </div>
                        </div>
                    </div>
...
<?php /**PATH C:\xampp\htdocs\klinik\resources\views/bcrpyt.blade.php ENDPATH**/ ?>