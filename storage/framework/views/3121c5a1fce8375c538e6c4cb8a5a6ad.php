...
<?php $__env->startSection('title', $service->title . ' - Al-Fatih Center'); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <section class="relative">
        <div class="w-full h-64 md:h-80 lg:h-96 bg-gradient-to-r from-blue-800 to-blue-600 overflow-hidden">
            <img src="<?php echo e($service->image_url); ?>" alt="<?php echo e($service->title); ?>" class="w-full h-full object-cover opacity-50">
            ...
            <div class="absolute inset-0 flex items-center justify-center text-center p-4">
                <div class="max-w-4xl">
                    <h1 class="text-3xl md:text-5xl font-bold mb-4 text-white"><?php echo e($service->title); ?></h1>
                </div>
            </div>
        </div>
    </section>
                ...
                <div class="p-6 md:p-10">
                    ...
                    <div class="mb-10 rounded-xl overflow-hidden shadow-lg transform hover:scale-[1.01] transition-transform duration-300">
                        ...
                        <div class="bg-gradient-to-r from-blue-600 to-blue-800 py-4 px-6">
                            <h2 class="text-xl md:text-2xl font-bold text-white"><?php echo e($service->title); ?></h2>
                        </div>
                    </div>
                    ...
                    <div class="mt-12 flex justify-center">
                        <a href="<?php echo e(route('home')); ?>" class="inline-flex items-center px-8 py-3 bg-blue-600 text-white font-medium rounded-lg transition-colors hover:bg-blue-700">
                            Kembali ke Beranda
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div class="bg-white rounded-xl shadow-md overflow-hidden transition-transform hover:scale-[1.02] duration-300">
                    <div class="h-48 overflow-hidden">
                        <img src="<?php echo e($otherService->image_url); ?>" alt="<?php echo e($otherService->title); ?>" class="w-full h-full object-cover">
                    </div>
                    <div class="p-6">
                        <h3 class="font-bold text-xl mb-2 text-blue-700"><?php echo e($otherService->title); ?></h3>
                        <p class="text-gray-600 mb-4 line-clamp-3"><?php echo e($otherService->short_description); ?></p>
                        <a href="<?php echo e(route('service.show', $otherService->slug)); ?>" class="text-blue-600 font-medium flex items-center">
                            Selengkapnya
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\klinik\resources\views/pages/service-detail.blade.php ENDPATH**/ ?>