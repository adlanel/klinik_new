            ...
            <tbody class="bg-white divide-y divide-gray-200">
                <?php $__empty_1 = true; $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr>
                        ...
                        <td class="px-4 py-4 whitespace-nowrap">
                            <div class="text-sm text-gray-900"><?php echo e($user->cabang ? $user->cabang->nama_cabang : '-'); ?></div>
                        </td>
                        <td class="px-4 py-4 whitespace-nowrap">
...
<?php echo $__env->make('layouts.admin.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\klinik\resources\views/admin/users/index.blade.php ENDPATH**/ ?>