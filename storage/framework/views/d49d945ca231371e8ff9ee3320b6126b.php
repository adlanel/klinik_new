...
<?php $__env->startSection('title', 'Cabang & Kontak - Klinik Alfatih Center'); ?>
    ...
    <div class="mb-12">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div class="bg-white rounded-lg shadow-md overflow-hidden">
                <div class="p-6">
                    <h3 class="text-xl font-bold text-gray-800 mb-2"><?php echo e($branch->nama_cabang); ?></h3>
                    <div class="mb-4">
                        <div class="flex items-start mb-2">
                            ...
                            <p class="ml-2 text-gray-600"><?php echo e($branch->alamat); ?></p>
                        </div>
                        <div class="flex items-center mb-2">
                            ...
                            <p class="ml-2 text-gray-600"><?php echo e($branch->no_telp); ?></p>
                        </div>
                    </div>
                    <div class="aspect-w-16 aspect-h-9 rounded-md overflow-hidden mb-4">
                        ...
                        <div class="w-full h-56 rounded-md overflow-hidden">
                            <iframe
                                ...
                                loading="lazy"
                                allowfullscreen
                                src="https://maps.google.com/maps?q=<?php echo e(urlencode($branch->alamat)); ?>&output=embed">
                            </iframe>
                        </div>
                    </div>
                    <a href="<?php echo e($branch->link_maps); ?>" 
                       target="_blank" 
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\klinik\resources\views/pages/cabang-kontak.blade.php ENDPATH**/ ?>