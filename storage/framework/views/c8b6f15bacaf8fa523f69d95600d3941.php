                ...
                <div class="mb-6">
                    <div>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="date" class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-500 focus:ring-opacity-50" id="meeting_date" name="meeting_date" value="<?php echo e(old('meeting_date', $appointment->meeting_date)); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="mb-4">
                            ...
                            <textarea class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-500 focus:ring-opacity-50" id="complaint" name="complaint" rows="5" required><?php echo e(old('complaint', $appointment->complaint)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="flex justify-between items-center mt-6">
                    <a href="<?php echo e(route('admin.appointments.index')); ?>" class="px-4 py-2 bg-gray-300 text-gray-700 rounded-md hover:bg-gray-400 flex items-center">
...
<?php echo $__env->make('layouts.admin.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\klinik\resources\views/admin/appointments/edit.blade.php ENDPATH**/ ?>