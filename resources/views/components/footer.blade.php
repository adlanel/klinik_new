        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div>
                ...
                <ul class="space-y-2">
                    ...
                    <li><a href="{{ route('about.index') }}" class="text-gray-300 hover:text-white transition-colors">Tentang Kami</a></li>
                    <li><a href="{{ route('layanan-fasilitas.index') }}" class="text-gray-300 hover:text-white transition-colors">Layanan & Fasilitas</a></li>
                    <li><a href="{{ route('news.index') }}" class="text-gray-300 hover:text-white transition-colors">Berita & Artikel</a></li>
                    <li><a href="{{ route('cabang-kontak.index') }}" class="text-gray-300 hover:text-white transition-colors">Cabang & Kontak</a></li>
                    <li><a href="{{ route('appointment.index') }}" class="text-gray-300 hover:text-white transition-colors">Buat Janji</a></li>
                </ul>
            </div>
    ...
    <div class="bg-blue-950 py-4">
        <div class="container mx-auto px-6">
            <div class="flex flex-col md:flex-row justify-between items-center">
                <p class="text-sm text-gray-400">&copy; {{ date('Y') }} Klinik Alfatih Center. Hak Cipta Dilindungi.</p>
