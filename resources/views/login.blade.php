    ...
    <div class="min-h-screen flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
        <div class="max-w-md w-full space-y-8">
            ...
            <div class="text-center">
                @if($currentLogo)
                    <img src="{{ asset('storage/logo/' . $currentLogo->path) }}" 
                         alt="Logo Klinik" 
            ...
            <div class="bg-white shadow-xl rounded-2xl p-8">
                <form class="space-y-6" action="{{ route('login.process') }}" method="POST" id="loginForm">
                    @csrf
                    ...
                    <div>
                        ...
                        <input id="email" 
                               ...
                               required 
                               value="{{ old('email') }}"
                               class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition-colors @error('email') border-red-500 @enderror"
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <input id="password" 
                                   ...
                                   type="password" 
                                   required
                                   class="w-full px-4 py-3 pr-12 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition-colors @error('password') border-red-500 @enderror"
                            ...
                            <div class="flex">
                                ...
                                <div class="ml-3">
                                    <h3 class="text-sm font-medium text-red-800">
                                        {{ session('error') ?? 'Terjadi kesalahan saat login' }}
                                    </h3>
                                </div>
                            </div>
                        </div>
            ...
            <div class="text-center text-sm text-gray-500">
                <p>&copy; {{ date('Y') }} Klinik. Semua hak dilindungi.</p>
                <p class="mt-1">
                    <a href="{{ url('/') }}" class="text-blue-600 hover:text-blue-500">
                        Kembali ke beranda
                    </a>
                </p>
            </div>
