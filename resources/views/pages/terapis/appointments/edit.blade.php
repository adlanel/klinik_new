...
<div class="bg-white rounded-lg shadow-md p-6">
    ...
    <div class="bg-white rounded-lg shadow-md overflow-hidden mb-6">
        ...
        <div class="p-6">
            ...
            <form action="{{ route('terapis.appointments.update', $appointment->id) }}" method="POST">
                @csrf
                @method('PUT')
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                    <div>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="datetime-local" class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-500 focus:ring-opacity-50" id="meeting_date" name="meeting_date" value="{{ old('meeting_date', date('Y-m-d\TH:i', strtotime($appointment->meeting_date))) }}" required>
                            @error('meeting_date')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                    ...
                    <div>
                        ...
                        <div class="mb-4">
                            ...
                            <textarea class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-500 focus:ring-opacity-50" id="complaint" name="complaint" rows="9" required>{{ old('complaint', $appointment->complaint) }}</textarea>
                            @error('complaint')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                ...
                <div class="flex justify-between">
                    <a href="{{ route('terapis.appointments.show', $appointment->id) }}" class="bg-gray-500 hover:bg-gray-600 text-white font-medium py-2 px-4 rounded">
