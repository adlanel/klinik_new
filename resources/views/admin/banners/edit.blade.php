...
<div class="bg-white rounded-lg shadow-md p-6">
    ...
    <form action="{{ route('admin.content.banners.update', $banner->id) }}" method="POST" enctype="multipart/form-data" class="max-w-4xl">
        @csrf
        @method('PUT')
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
            ...
            <div class="bg-gray-50 p-6 rounded-lg border">
                ...
                <div class="mb-4">
                    ...
                    <div class="bg-white p-2 rounded-lg border">
                        <img src="{{ $banner->desktop_image_url }}" alt="Current Desktop Banner" class="max-w-full h-auto">
                    </div>
                </div>
            ...
            <div class="bg-gray-50 p-6 rounded-lg border">
                ...
                <div class="mb-4">
                    ...
                    <div class="bg-white p-2 rounded-lg border">
                        <img src="{{ $banner->mobile_image_url }}" alt="Current Mobile Banner" class="max-w-full h-auto">
                    </div>
                </div>
        ...
        <div class="mb-6">
            ...
            <input type="url" name="link_url" id="link_url" value="{{ old('link_url', $banner->link_url) }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-500 focus:ring-opacity-50" placeholder="https://example.com">
        ...
        <div class="mb-6">
            ...
            <input type="number" name="order_number" id="order_number" value="{{ $banner->order_number }}" min="1" class="mt-1 block w-full md:w-1/4 rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-500 focus:ring-opacity-50" required>
            <p class="text-xs text-gray-500 mt-1">
