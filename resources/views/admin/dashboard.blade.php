        ...
        <div class="bg-white overflow-hidden rounded-lg shadow-lg border-l-4 border-blue-500">
                ...
                <div class="mt-5">
                    <div class="flex items-center justify-between">
                        <div class="flex items-center">
                            <span class="{{ $percentageChange >= 0 ? 'text-green-600' : 'text-red-600' }} flex items-center font-medium">
                                <i class="fas fa-{{ $percentageChange >= 0 ? 'arrow-up' : 'arrow-down' }} mr-1"></i>
                                {{ abs(round($percentageChange)) }}%
                            </span>
            ...
            <div class="bg-gray-50 px-6 py-2">
                <div class="h-2 w-full bg-gray-200 rounded-full overflow-hidden">
                    <div class="h-full bg-blue-500 rounded-full" style="width: {{ min(100, max(5, abs(round($percentageChange)))) }}%"></div>
                </div>
            </div>
        </div>
            ...
            <div class="p-6">
                ...
                <div class="mt-5">
                    <div class="flex items-center justify-between">
                        ...
                        <a href="{{ route('admin.patients.index') }}" class="text-xs text-green-600 hover:text-green-800 font-medium">
                            Lihat Detail
                        </a>
                    </div>
                </div>
            ...
            <div class="p-6">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-3xl font-bold text-gray-800 mt-1">{{ $totalNews }}</p>
                    </div>
                ...
                <div class="mt-5">
                    <div class="flex items-center justify-between">
                        ...
                        <a href="{{ route('admin.content.news.index') }}" class="text-xs text-purple-600 hover:text-purple-800 font-medium">
                            Kelola
                        </a>
                    </div>
                </div>
            ...
            <div class="p-6">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-3xl font-bold text-gray-800 mt-1">{{ $totalCabang }}</p>
                    </div>
                ...
                <div class="mt-5">
                    <div class="flex items-center justify-between">
                        ...
                        <a href="{{ route('admin.content.branches.index') }}" class="text-xs text-yellow-600 hover:text-yellow-800 font-medium">
                            Kelola
                        </a>
                    </div>
                </div>
        ...
        <div class="bg-white rounded-lg shadow-md p-6 border-t-4 border-green-500">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-xl font-bold text-gray-800">{{ $activePatients }}</p>
                </div>
            ...
            <div class="mt-4 text-sm font-medium text-gray-500">
                {{ round(($activePatients/$totalPatients) * 100) }}% dari total pasien
            </div>
        </div>
        ...
        <div class="bg-white rounded-lg shadow-md p-6 border-t-4 border-yellow-500">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-xl font-bold text-gray-800">{{ $pendingAppointments }}</p>
                </div>
            ...
            <div class="mt-4 text-sm font-medium text-gray-500">
                {{ $pendingAppointments > 0 ? 'Perlu ditinjau' : 'Tidak ada yang pending' }}
            </div>
        </div>
        ...
        <div class="bg-white rounded-lg shadow-md p-6 border-t-4 border-blue-500">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-xl font-bold text-gray-800">{{ $totalLayanan }}</p>
                </div>
        ...
        <div class="bg-white rounded-lg shadow-md p-6 border-t-4 border-indigo-500">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-xl font-bold text-gray-800">{{ $totalFasilitas }}</p>
                </div>
    ...
    <div class="grid grid-cols-1 gap-6 mb-8">
        ...
        <div class="bg-white rounded-lg shadow-md overflow-hidden">
            <div class="p-6 border-b border-gray-100 flex justify-between items-center">
                ...
                <div>
                    <a href="{{ route('admin.appointments.index') }}" class="text-blue-600 hover:text-blue-800 text-sm font-medium inline-flex items-center">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        @forelse($recentAppointments as $appointment)
                            <tr>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="text-sm text-gray-900">{{ $appointment->cabang ? $appointment->cabang->nama_cabang : 'N/A' }}</div>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="text-sm text-gray-900">{{ \Carbon\Carbon::parse($appointment->meeting_date)->format('d M Y') }}</div>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap">
    ...
    <div class="grid grid-cols-1 gap-6">
        ...
        <div class="bg-white rounded-lg shadow-md p-6">
            <div class="flex justify-between items-center mb-6">
                ...
                <a href="{{ route('admin.content.branches.index') }}" class="text-blue-500 text-sm hover:underline flex items-center">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        <tr>
                            <td class="px-3 py-4 whitespace-nowrap">
                                <div class="text-sm font-medium text-gray-900">{{ $branch->nama_cabang }}</div>
                            </td>
                            <td class="px-3 py-4 whitespace-nowrap text-sm text-gray-900">{{ $branch->patients_count ?? 0 }}</td>
                            <td class="px-3 py-4 whitespace-nowrap text-sm text-gray-900">{{ $branch->consultations_count ?? 0 }}</td>
                            <td class="px-3 py-4 whitespace-nowrap">
                                <span class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full bg-green-100 text-green-800">
                                    Aktif
                                </span>
...
@if(isset($section) && $section == 'appointments')
...
@if(isset($section) && $section == 'patients')
    <div class="mt-8 bg-white rounded-lg shadow-md p-6">
