            ...
            <tbody class="bg-white divide-y divide-gray-200">
                @forelse($patients as $index => $patient)
                    <tr>
                        ...
                        <!-- Detail Profil -->
                        <td class="px-4 py-4 whitespace-nowrap text-center">
                            <a href="{{ route('admin.patients.show', $patient->id_pasien) }}" class="text-blue-600 hover:text-blue-900 p-2 rounded-full hover:bg-blue-50">
                        ...
                        <!-- History -->
                        <td class="px-4 py-4 whitespace-nowrap text-center">
                            <a href="{{ route('admin.patients.history', $patient->id_pasien) }}" class="text-purple-600 hover:text-purple-900 p-2 rounded-full hover:bg-purple-50">
