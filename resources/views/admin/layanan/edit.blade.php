...
<div class="container px-6 py-8 mx-auto">
    <div class="flex justify-between items-center">
        <h3 class="text-3xl font-medium text-gray-700">Edit Layanan</h3>
    ...
    <div class="mt-8">
        ...
        <div class="bg-white p-6 rounded-md shadow">
            <form action="{{ route('admin.content.layanan.update', $layanan->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                
                <div class="mb-6">
                    <label for="title" class="block text-sm font-medium text-gray-700 mb-2">Judul Layanan</label>
                    <input type="text" name="title" id="title" value="{{ old('title', $layanan->title) }}" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring focus:ring-blue-200" required>
                    @error('title')
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                    <div>
                        ...
                        <input type="number" step="0.01" min="0" name="harga_reguler_weekday" id="harga_reguler_weekday" value="{{ old('harga_reguler_weekday', $layanan->harga_reguler_weekday ?? 0) }}" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring focus:ring-blue-200">
                    ...
                    <div>
                        ...
                        <input type="number" step="0.01" min="0" name="harga_paket_weekday" id="harga_paket_weekday" value="{{ old('harga_paket_weekday', $layanan->harga_paket_weekday ?? 0) }}" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring focus:ring-blue-200">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                    <div>
                        ...
                        <input type="number" step="0.01" min="0" name="harga_reguler_weekend" id="harga_reguler_weekend" value="{{ old('harga_reguler_weekend', $layanan->harga_reguler_weekend ?? 0) }}" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring focus:ring-blue-200">
                    ...
                    <div>
                        ...
                        <input type="number" step="0.01" min="0" name="harga_paket_weekend" id="harga_paket_weekend" value="{{ old('harga_paket_weekend', $layanan->harga_paket_weekend ?? 0) }}" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring focus:ring-blue-200">
                ...
                <div class="mb-6">
                    ...
                    <textarea name="short_description" id="short_description" rows="3" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring focus:ring-blue-200">{{ old('short_description', $layanan->short_description) }}</textarea>
                ...
                <div class="mb-6">
                    ...
                    <textarea name="description" id="description" rows="10" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring focus:ring-blue-200">{{ old('description', $layanan->description) }}</textarea>
                ...
                <div class="mb-6">
                    ...
                    <div class="mb-4">
                        <img src="{{ $layanan->image_url }}" alt="Current Image" class="h-40 object-contain border rounded">
                    </div>
