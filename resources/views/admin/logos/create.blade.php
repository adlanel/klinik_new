...
@section('title', 'Upload Logo Baru')
...
<div class="bg-white rounded-lg shadow-md p-6">
    ...
    <form action="{{ route('admin.content.logos.store') }}" method="POST" enctype="multipart/form-data" class="max-w-2xl">
        @csrf
        ...
        <div class="flex justify-between items-center pt-4 border-t border-gray-200">
            <a href="{{ route('admin.content.logos.index') }}" class="text-gray-600 hover:text-gray-800">
